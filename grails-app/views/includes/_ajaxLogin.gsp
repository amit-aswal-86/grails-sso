...
<span id="s2ui_login_link_container">
	...
	<div id="loginLinkContainer">
		...
		<g:message code='spring.security.ui.login.loggedInAs' args='[sec.username()]'/>
			(<g:link controller='logout'><g:message code='spring.security.ui.login.logout'/></g:link>)
		</sec:ifLoggedIn>
		<sec:ifNotLoggedIn>
			<a href="${createLink(controller: 'login', action: 'auth')}" id="loginLink"><g:message code='spring.security.ui.login.login'/></a>
		</sec:ifNotLoggedIn>
		<sec:ifSwitched>
